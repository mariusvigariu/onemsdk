...
from parser import build_node, get_root_tag
...
class TestParser(TestCase):
    def test_build_node_small(self):
        ...
        self.assertEqual('First section text', node.children[0].children[0])

        self.assertEqual(2, len(node.children[1].children[0].attrs.keys()))

        self.assertEqual('input-name', node.children[1].children[0].attrs['name'])
